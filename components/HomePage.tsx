...
const HomePage = () => {
  return (
    <div className="h-screen w-screen bg-space ">
        ...
        <div className="w-screen h-screen overflow-hidden absolute top-0 left-0" style={{"background-image" : "url('Bg-stars.png')"}}/>
        <div className="w-screen h-screen overflow-hidden absolute top-0 left-0" style={{"background-image" : "url('Md-stars.png')"}}/>
        <div className="w-screen h-screen overflow-hidden absolute top-0 left-0" style={{"background-image" : "url('Sm-stars.png')"}}/>
        ...
        <div className="w-screen absolute bottom-0 left-0 overflow-hidden h-sm bg-cover" style={{"background-image" : "url('Earth_WH.png')"}}/>
