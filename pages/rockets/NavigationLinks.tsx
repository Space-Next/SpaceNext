  ...
  return (
    <div className="xl:h-96 xl:w-1/5 mb-5 md:mb-10 xl:mb-0 mx-4 lg:mx-0 xl:pb-10 xl:px-4 flex xl:flex-col xl:ml-10 xl:justify-center rounded-md overflow-x-auto">
      ...
      {formattedData.map((element, index) => (
        ...
        >
          <a className={`lg:py-3 xl:py-5 lg:px-10 xl:px-0 mr-10 xl:mr-0 xl:mb-4 text-2xl lg:text-base lg:rounded-lg lg:border-2 lg:border-transparent font-semibold text-white whitespace-nowrap ${
            selection === index
